(() => {
    ...
    const i = jQuery;
    var t = e.n(i);
    const r = "jqueryUploader", l = "defaultUploaderOptions", s = ".jquery-uploader-preview-progress", a = "image",
        o = "other", n = ["jpg", "png", "jpeg", "gif", "bmp"], d = function () {
    ...
    class h {
        ...
        createDefaultFiles(e) {
            ...
            this.options.defaultValue ? i = this.options.defaultValue : e && (this.options.multiple ? e.split(",") : [e]).forEach(((e, t) => {
                ...
                let i = u(), t = this.createFileCardEle(i, e.url, e.type);
                this.files.push({
                    id: i,
                    type: e.type,
                    name: e.name,
        ...
        handleFileAdd(e) {
            ...
            for (let t = 0; t < e.length; t++) {
                let r = e[t], l = -1 !== r.type.indexOf("image") ? a : o, s = d.createBlobUrl(r), n = u(),
        ...
        handleFileDelete(e) {
            let i = t()(e.target).parents(".jquery-uploader-card"), r = i[0].id;
            i.remove();
            let l = -1;
    ...
    }, h.mode = {url: "url", file: "file", custom: "custom"}, h.fileStatus = {
        selected: "selected",
        uploading: "uploading",
        uploaded: "uploaded",
        error: "error",
