                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-4">
                                <form action="{{  route('admin.why-use.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <!-- Icon -->
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control" placeholder="Enter name" required>
                                            </div>
                                        </div>
