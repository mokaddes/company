                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="list_title" id="list_title" value="{{ old('list_title') }}" class="form-control" placeholder="Enter your post title" required>
                                                    </div>
                                                </div>
                                                <!-- Post Subtitle -->
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="subtitle" id="subtitle" value="{{ old('subtitle') }}" class="form-control" placeholder="Enter a subtitle" required>
                                                    </div>
                                                </div>
                                                <!-- brand name -->
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="brand" id="brand" value="{{ old('brand') }}" class="form-control" placeholder="Enter your brand name" required>
                                                    </div>
                                                </div>
                                                <!-- Button Color -->
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="button_text" id="button_text" value="{{ old('button_text') }}" class="form-control" placeholder="Enter your button text" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="title" id="title" value="{{ old('title') }}" class="form-control" placeholder="Enter your post title" required>
                                                    </div>
                                                </div>
                                                <!-- category -->
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="category" id="category" value="{{ old('category') }}" class="form-control" placeholder="Enter your category" required>
                                                    </div>
                                                </div>
                                                <!-- brief -->
                                                <div class="col-md-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <textarea name="brief" id="brief" class="form-control" rows="3" placeholder="Enter work brief" ></textarea>
                                                    </div>
                                                </div>
                                                <!-- Result -->
                                                <div class="col-md-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <textarea name="result" id="result" class="form-control" rows="3" placeholder="Enter work result" ></textarea>
                                                    </div>
                                                </div>
                                                <!-- Procedure -->
                                                <div class="col-md-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <textarea name="procedures" id="procedure" class="form-control" rows="3" placeholder="Enter work procedure" ></textarea>
                                                    </div>
                                                </div>
                                                <!-- client quote -->
                                                <div class="col-md-12">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <textarea name="client_quote" id="client_quote" class="form-control" rows="3" placeholder="Enter client quote" ></textarea>
                                                    </div>
                                                </div>
                                                <!-- client name -->
                                                <div class="col-md-6">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <input type="text" name="client_name" id="client_name" value="{{ old('client_name') }}" class="form-control" placeholder="Enter client name" >
                                                    </div>
                                                </div>
